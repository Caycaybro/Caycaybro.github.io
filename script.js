function SnowStorm() {
  ...
  null === f.flakeLeftOffset && (f.flakeLeftOffset = 0),
    null === f.flakeRightOffset && (f.flakeRightOffset = 0),
    (this.meltFrameCount = 20),
    (this.meltFrames = []);
  for (var A = 0; A < this.meltFrameCount; A++)
    this.meltFrames.push(1 - A / this.meltFrameCount);
  (this.randomizeWind = function () {
    if (((s = b(a(f.vMaxX, 0.2))), (t = a(f.vMaxY, 0.2)), this.flakes))
      for (var c = 0; c < this.flakes.length; c++)
    ...
    (this.scrollHandler = function () {
      if (
        ...
        isNaN(r) && (r = 0),
        !x && !f.flakeBottom && f.flakes)
      )
        for (var a = f.flakes.length; a--; )
          0 === f.flakes[a].active && f.flakes[a].stick();
    }),
    (this.resizeHandler = function () {
      window.innerWidth || window.innerHeight
        ? ((o = window.innerWidth - (h ? 2 : 16) - f.flakeRightOffset),
          (q = f.flakeBottom ? f.flakeBottom : window.innerHeight))
        : ((o =
    ...
    (this.resizeHandlerAlt = function () {
      (o =
        f.targetElement.offsetLeft +
        f.targetElement.offsetWidth -
        f.flakeRightOffset),
        (q = f.flakeBottom
          ? f.flakeBottom
          : f.targetElement.offsetTop + f.targetElement.offsetHeight),
        (p = parseInt(o / 2, 10));
    }),
    ...
    (this.toggleSnow = function () {
      f.flakes.length
        ? ((f.active = !f.active),
          f.active ? (f.show(), f.resume()) : (f.stop(), f.freeze()))
        : f.start();
    }),
    (this.stop = function () {
      this.freeze();
      ...
      e(window, "scroll", f.scrollHandler),
        e(window, "resize", f.resizeHandler),
        j || (e(window, "blur", f.freeze), e(window, "focus", f.resume));
    }),
    (this.show = function () {
      for (var a = this.flakes.length; a--; )
    ...
    (this.SnowFlake = function (b, c, d, e) {
      ...
      (this.type = c),
        ...
        (this.refresh = function () {
          return isNaN(f.x) || isNaN(f.y)
            ? !1
            : ((f.o.style.left = f.x + "px"),
              void (f.o.style.top = f.y + "px"));
        }),
        (this.stick = function () {
          n ||
          (g.targetElement != document.documentElement &&
            g.targetElement != document.body)
        ...
        (this.vCheck = function () {
          f.vX >= 0 && f.vX < 0.2
            ? (f.vX = 0.2)
            : f.vX < 0 && f.vX > -0.2 && (f.vX = -0.2),
            f.vY >= 0 && f.vY < 0.2 && (f.vY = 0.2);
        }),
        (this.move = function () {
          var a = f.vX * u;
          (f.x += a),
            (f.y += f.vY * f.vAmp),
            f.x >= o || o - f.x < g.flakeWidth
              ? (f.x = 0)
              : 0 > a &&
                f.x - g.flakeLeftOffset < 0 - g.flakeWidth &&
                (f.x = o - g.flakeWidth - 1),
            f.refresh();
          var b = q + r - f.y;
          b < g.flakeHeight
            ...
            : (g.useMeltEffect &&
              ...
              g.useTwinkleEffect &&
                (f.twinkleFrame
                  ? (f.twinkleFrame--,
                    (f.o.style.visibility =
                      f.twinkleFrame && f.twinkleFrame % 2 === 0
                        ? "hidden"
                        : "visible"))
                  : Math.random() > 0.9 &&
                    (f.twinkleFrame = parseInt(20 * Math.random(), 10))));
        }),
        (this.animate = function () {
          f.move();
        }),
        (this.setVelocities = function () {
          (f.vX = s + a(0.12 * g.vMaxX, 0.1)),
            (f.vY = t + a(0.12 * g.vMaxY, 0.1));
        }),
        ...
        (this.melt = function () {
          g.useMeltEffect && f.melting && f.meltFrame < f.meltFrameCount
            ? (f.meltFrame++,
              ...
              (f.o.style.fontSize =
                f.fontSize -
                f.fontSize * (f.meltFrame / f.meltFrameCount) +
                "px"),
              (f.o.style.lineHeight =
                g.flakeHeight +
                2 +
                0.75 * g.flakeHeight * (f.meltFrame / f.meltFrameCount) +
                "px"))
            : f.recycle();
        }),
    ...
    (this.snow = function () {
      for (var b = 0, c = 0, d = 0, e = null, g = f.flakes.length; g--; )
        1 == f.flakes[g].active
          ? (f.flakes[g].move(), b++)
          : 0 === f.flakes[g].active
          ? c++
          : d++,
          f.flakes[g].melting && f.flakes[g].melt();
      b < f.flakesMaxActive &&
        ((e = f.flakes[parseInt(a(f.flakes.length), 10)]),
        0 === e.active && (e.melting = !0));
    }),
    ...
    (this.createSnow = function (b, c) {
      for (var d = 0; b > d; d++)
        (f.flakes[f.flakes.length] = new f.SnowFlake(f, parseInt(a(w), 10))),
          (c || d > f.flakesMaxActive) &&
            (f.flakes[f.flakes.length - 1].active = -1);
      g.targetElement.appendChild(z);
    }),
    (this.timerInit = function () {
      f.timers = k
        ? [
            setInterval(f.snow, 3 * f.animationInterval),
            setInterval(f.snow, f.animationInterval),
          ]
        : [setInterval(f.snow, f.animationInterval)];
    }),
    (this.init = function () {
  ...
  (this.start = function (a) {
    ...
    if ("string" == typeof f.targetElement) {
      ...
      if (((f.targetElement = document.getElementById(b)), !f.targetElement))
    ...
    f.targetElement ||
      (f.targetElement = h
        ...
        ? document.documentElement
        : document.body),
      f.targetElement != document.documentElement &&
        f.targetElement != document.body &&
        (f.resizeHandler = f.resizeHandlerAlt),
      f.resizeHandler(),
      ...
      offsetParent: function () {
        return this.map(function () {
          for (
            ...
            a && !L.test(a.nodeName) && "static" == x(a).css("position");
...
(window.Zepto = Zepto),
  ...
  (function (a) {
    function b(b) {
      return (
        (b = a(b)), !(!b.width() && !b.height()) && "none" !== b.css("display")
      );
    }
    function c(a, b) {
      a = a.replace(/=#\]/g, '="#"]');
    ...
    (d.qsa = function (b, f) {
      return c(f, function (c, g, h) {
        try {
          ...
          !c && g
            ? (c = "*")
            : i.test(c) && ((k = a(b).addClass(j)), (c = "." + j + " " + c));
          var l = e(b, c);
        } catch (m) {
  ...
  (function (a, b) {
    ...
    a.each(p, function (a, c) {
      return r.style[a + "TransitionProperty"] !== b
        ? ((o = "-" + a.toLowerCase() + "-"), (e = c), !1)
        : void 0;
    }),
      (f = o + "transform"),
      (t[(g = o + "transition-property")] =
        t[(h = o + "transition-duration")] =
        t[(j = o + "transition-delay")] =
        t[(i = o + "transition-timing-function")] =
        t[(k = o + "animation-name")] =
        t[(l = o + "animation-duration")] =
        t[(n = o + "animation-delay")] =
        t[(m = o + "animation-timing-function")] =
          ""),
      (a.fx = {
      ...
      (a.fn.animate = function (c, d, e, f, g) {
        return (
          a.isFunction(d) && ((f = d), (e = b), (d = b)),
          a.isFunction(e) && ((f = e), (e = b)),
          a.isPlainObject(d) &&
            ((e = d.easing), (f = d.complete), (g = d.delay), (d = d.duration)),
          d &&
            (d =
              ("number" == typeof d
                ? d
                : a.fx.speeds[d] || a.fx.speeds._default) / 1e3),
      ...
      (a.fn.anim = function (d, e, o, p, q) {
        var r,
          ...
          A = !1;
        if (
          (e === b && (e = a.fx.speeds._default / 1e3),
          q === b && (q = 0),
          a.fx.off && (e = 0),
          "string" == typeof d)
        )
  ...
  (function (a, b) {
    function c(c, d, e, f, g) {
      ...
      var h = { opacity: e };
      return (
        f && ((h.scale = f), c.css(a.fx.cssPrefix + "transform-origin", "0 0")),
    ...
    (a.fn.show = function (a, d) {
      ...
      (a.fn.fadeIn = function (a, b) {
        ...
        return (
          c > 0 ? this.css("opacity", 0) : (c = 1), f.call(this).fadeTo(a, c, b)
        );
      }),
      ...
      (a.fn.fadeToggle = function (b, c) {
        return this.each(function () {
          var d = a(this);
          d[
            0 == d.css("opacity") || "none" == d.css("display")
              ? "fadeIn"
              : "fadeOut"
          ](b, c);
        });
    ...
    (a.step1 = function () {
      ...
      (a.step2 = function () {
        ...
        e.addClass("opacity1 rubberBand").one(b, a.step3),
          setTimeout(function () {
            c.addClass("opacity1").removeClass("tn"),
              d.addClass("opacity1").removeClass("tn");
          }, 600);
      }),
      (a.step3 = function () {
        var c = $(".j-gift1"),
